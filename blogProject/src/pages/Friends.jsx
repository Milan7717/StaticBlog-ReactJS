...
const aboutBlogApi = [
  ...
  },
  {
    ...
    imagecard: [
      "assets/friendsimg/childhood1.JPG",
      "assets/friendsimg/childhood2.jpg",
      "assets/friendsimg/childhood3.jpg",
    ],
  },
  {
    ...
    imagecard: [
      "assets/friendsimg/school1.jpg",
      "assets/friendsimg/school2.jpg",
      "assets/friendsimg/school3.jpeg",
    ],
  },
  {
    ...
    imagecard: [
      "assets/friendsimg/bestfrd2.JPG",
      "assets/friendsimg/bca.jpg",
      "assets/friendsimg/bestfrd4.jpg",
      "assets/friendsimg/bca2.jpg",
    ],
  },
  {
    ...
    imagecard: [
      "assets/friendsimg/comedy1.jpg",
      "assets/friendsimg/comedy2.jpg",
      "assets/friendsimg/comedy3.jpg",
    ],
  },
  {
    heading: "Conclusion",
...
const friendsCarousel = [
  "assets/friendsimg/schoolfrds.jpg",
  "assets/friendsimg/newones.jpg",
  "assets/friendsimg/bca.jpg",
];
